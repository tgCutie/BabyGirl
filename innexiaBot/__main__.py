...
PM_START_TEXT = """
Hello 💕 I am Angelina! [🔥](https://telegra.ph/file/779e61810b25b850f3033.jpg) : The Fastest and Safest Telegram Group Management Bot!\nClick on [Hᴇʟᴘ & Cᴏᴍᴍᴀɴᴅꜱ 🛠️](http://t.me/Angelina_robot?start=help) to know about my Features!
"""

buttons = [
    [
        InlineKeyboardButton(
            text="💕 ᴀᴅᴅ ᴀɴɢᴇʟɪɴᴀ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ! 🔥", url="http://t.me/Angelina_robot?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(text="⚡ ꜱᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ", url=f"https://t.me/desk_angelina"),
        InlineKeyboardButton(
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", url="t.me/desk_angelina")]]
            ),
        )
...
def innexia_about_callback(update, context):
    ...
    if query.data == "innexia_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Bᴜɢ'ꜱ", url="t.me/desk_angelina"
                        ),
                        InlineKeyboardButton(
                            text="Bᴏᴛ Lɪꜱᴛ", url="t.me/Angelina_updates"
                        ),
                    ],
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Aᴅᴍɪɴ", callback_data="Angelina_devs"),
                    InlineKeyboardButton(text="Nᴏᴛᴇꜱ", callback_data="Angelina_notes"),
                 ],
                 [
                    InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", callback_data="desk_angelina"),
                    InlineKeyboardButton(text="Credit", callback_data="Angelina_dev"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="innexia_back"),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Lᴏɢ'ꜱ", url="t.me/Angelina_Logs"),
                    InlineKeyboardButton(text="Fᴇᴅ", url="t.me/AngelinaFedChat"),
                 ],
                 [
                    InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", url="t.me/desk_angelina"),
                    InlineKeyboardButton(text="Uᴘᴅᴀᴛᴇꜱ", url="https://t.me/Angelina_updates"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="innexia_basichelp"),
    ...
    elif query.data == "Angelina_devs":
        query.message.edit_text(
            text=f"<b> CREDIT FOR Angelina DEVS</b>\n"
            f"\nHere Some Developers Helping in Making The Angelina RoBot",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text="""😬Project Private! Contact My Developer Team at @desk_angelina .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
