...
PM_START_TEXT = """
`ʜᴇʟʟᴏ` 🤗 `ɪ ᴀᴍ` [ʙᴀʙʏɢɪʀʟ](https://telegra.ph/file/b462dd07e59203b542def.jpg) ` ᴘᴏᴡᴇʀꜰᴜʟʟ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ`
...
buttons = [
    [
        InlineKeyboardButton(
            text="💕 ᴀᴅᴅ ʙᴀʙʏɢɪʀʟ ᴛᴏ ʏᴏᴜʀ ᴄʜᴀᴛ", url="http://t.me/BabyGirl_robot?startgroup=true"),
    ],
    [
...
def innexia_about_callback(update, context):
    ...
    if query.data == "innexia_":
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Aᴅᴍɪɴ", callback_data="babygirl_devs"),
                    InlineKeyboardButton(text="Nᴏᴛᴇꜱ", callback_data="BabyGirl_notes"),
                 ],
                 [
                    InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", callback_data="desk_babygirl"),
                    InlineKeyboardButton(text="Credit", callback_data="babygirl_devs"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="innexia_back"),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Lᴏɢ'ꜱ", url="t.me/BabyGirl_Logs"),
                    InlineKeyboardButton(text="Fᴇᴅ", url="t.me/BabyGirlFedChat"),
                 ],
                 [
                    InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", url="t.me/desk_babygirl"),
    ...
    elif query.data == "babygirl_devs":
        query.message.edit_text(
            text=f"<b> CREDIT FOR BABYGIRL DEVS</b>\n"
            f"\nHere Some Developers Helping in Making The Babygirl RoBot",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="ʜɪᴍᴀɴsʜᴜ", url="t.me/cloneXcopy"),
                    InlineKeyboardButton(text="ʀᴏᴄᴋsᴛᴀʀ", url="t.me/ITZ_R0CKSTAR"),
                 ],
                 [
                    InlineKeyboardButton(text="ᴋʜᴜsʜɪ", url="t.me/D3VILgirl"),
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text="""😬Project Private! Contact My Developer Team at @desk_babygirl .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
